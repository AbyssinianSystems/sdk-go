...
// checks if the SubjectEvaluationHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubjectEvaluationHistory{}

// SubjectEvaluationHistory struct for SubjectEvaluationHistory
type SubjectEvaluationHistory struct {
	SubjectId string `json:"subject_id"`
	Items []SubjectEvaluationBundle `json:"items"`
}

type _SubjectEvaluationHistory SubjectEvaluationHistory
...
func (o SubjectEvaluationHistory) MarshalJSON() ([]byte, error) {
...
func (o SubjectEvaluationHistory) ToMap() (map[string]interface{}, error) {
...
func (o *SubjectEvaluationHistory) UnmarshalJSON(data []byte) (err error) {
	...
	varSubjectEvaluationHistory := _SubjectEvaluationHistory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubjectEvaluationHistory)

	if err != nil {
		return err
	}

	*o = SubjectEvaluationHistory(varSubjectEvaluationHistory)

	return err
}

type NullableSubjectEvaluationHistory struct {
	value *SubjectEvaluationHistory
	isSet bool
}

func (v NullableSubjectEvaluationHistory) Get() *SubjectEvaluationHistory {
	return v.value
}

func (v *NullableSubjectEvaluationHistory) Set(val *SubjectEvaluationHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableSubjectEvaluationHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableSubjectEvaluationHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubjectEvaluationHistory(val *SubjectEvaluationHistory) *NullableSubjectEvaluationHistory {
	return &NullableSubjectEvaluationHistory{value: val, isSet: true}
}

func (v NullableSubjectEvaluationHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubjectEvaluationHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
